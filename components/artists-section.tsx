  ...
  const artists = [
    {
      ...
      description: "Pioneering soundscapes that blur the line between digital and organic.",
      releases: 3,
      streams: "2.1M",
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Discover the talented musicians pushing boundaries and creating the future of electronic music.
          </p>
        </div>
            ...
            >
              <CardContent className="p-0">
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  <Badge className="absolute top-4 right-4 bg-accent text-accent-foreground">{artist.genre}</Badge>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-primary font-semibold">{artist.releases} Releases</span>
                    <span className="text-accent font-semibold">{artist.streams} Streams</span>
                  </div>
                </div>
              </CardContent>
            </Card>
